...
CREATE INDEX "medical_history_id_invoices_index" ON "invoices"("medical_history_id");
CREATE INDEX "invoice_id_index" ON "invoice_items"("invoice_id");
CREATE INDEX "treatments_id_invoice_items_index" ON "invoice_items"("treatments_id");
